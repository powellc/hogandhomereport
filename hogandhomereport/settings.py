"""
Django settings for our hogandhomereport project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'hogandhomereport/apps'))
    ...
    ROOT_URLCONF = 'hogandhomereport.urls'

    WSGI_APPLICATION = 'hogandhomereport.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "hogandhomereport/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "hogandhomereport/static"),
    )
